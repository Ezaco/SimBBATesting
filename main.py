...
def rungame(gameid, awayteam, hometeam, is_neutral, filePath):
        ...
        if possession == t1:
            ...
            if possrand < t1StealCutoff:
                ...
                if otherTO < 0.582:
                    ...
                    msg = possession + ": Shot clock violation on "+ t1 + " " + printShooter + "."
                    collector.AppendPlay(possession, msg, "Shot Clock Violation", t1pts, t2pts, possessionNum, total_possessions)
                elif otherTO < 1:
                    msg = possession + ": Offensive foul on " + t1 + " " + printShooter + "."
                ...
                if eventOutcome < made3Cutoff:
                    ...
                    if assistRand > 0.173:
                        ...
                        pickPlayer = random.choices(assistList,weights=[x.AssistPer for x in assistList],k=1)
                    ...
                    if rebrand < t1OffensiveRebound:
                        ...
                        play += "       Rebounded by " + t1 + " " + printt1Rebounder + "."
                        ...
                        play += "       Rebounded by " + t2 + " " + printt2Rebounder + "."
                    ...
                    play = printShooter + " 3-point attempt...BLOCKED by " + t2 + " " + printBlocker + "."
                    rebrand = random.random()
                    if rebrand < 0.43:
                        pickt1Rebounder = random.choices(gett1Players,weights=[x.ReboundingPer for x in team_one_roster],k=1)
                        t1rebounder = pickt1Rebounder[0]
                    ...
                    play_by_play.append(printShooter + " 3-point attempt... Missed. There is a foul on the play.")
                    ...
                    while foulShots > 0:
                        if random.random() <= ftCutoff:
                            ...
                            t1pts += 1
                            team_one.Stats.AddPoints(1, possessionNum, halftime_point, is_ot)
                    ...
                    if assistRand > 0.173:
                        assistList = [x for x in gett1Players if x.ID != shooter.ID]
                        pickAssister = random.choices(assistList,weights=[x.AssistPer for x in assistList],k=1)
                ...
                if eventOutcome < made2jCutoff:
                    ...
                    blocker.Stats.AddBlock()
                    printBlocker = blocker.FirstName + " " + blocker.LastName
                    play = printShooter + " 2-point jumper...BLOCKED by " + t2 + " " + printBlocker + "."
                    rebrand = random.random()
                    if rebrand < 0.43:
                        pickt1Rebounder = random.choices(gett1Players,weights=[x.ReboundingPer for x in team_one_roster],k=1)
                        t1rebounder = pickt1Rebounder[0]
                    ...
                    msg = printShooter + " 2-point jumper... Missed with a foul on the play."
                    shooter.Stats.AddFieldGoal(False, 2)
                    team_one.Stats.AddFieldGoal(False)
                    team_two.Stats.AddFoul()
                    foulShots = 2
                    ...
                    msg = printShooter + " 2-point jumper...Score! Foul on the play and one!"
                    t1pts += 2
                    shooter.Stats.AddFieldGoal(True, 2)
                    team_one.Stats.AddFieldGoal(True)
                    team_one.Stats.AddPoints(2, possessionNum, halftime_point, is_ot)
                ...
                if eventOutcome < made2iCutoff:
                    ...
                    blocker.Stats.AddBlock()
                    printBlocker = blocker.FirstName + " " + blocker.LastName
                    play = printShooter + " Inside shot...BLOCKED by " + t2 + " " + printBlocker + "."
                    rebrand = random.random()
                    if rebrand < 0.43:
                        pickt1Rebounder = random.choices(gett1Players,weights=[x.ReboundingPer for x in team_one_roster],k=1)
                        t1rebounder = pickt1Rebounder[0]
                    ...
                    msg = printShooter + " Inside shot... Missed with a foul on the play."
                    shooter.Stats.AddFieldGoal(False, 2)
                    team_one.Stats.AddFieldGoal(False)
                    team_two.Stats.AddFoul()
                    foulShots = 2
                    ...
                    msg = printShooter + " Inside shot...Score! Foul on the play and one!"
                    t1pts += 2
                    shooter.Stats.AddFieldGoal(True, 2)
                    team_one.Stats.AddFieldGoal(True)
                    team_one.Stats.AddPoints(2, possessionNum, halftime_point, is_ot)
            ...
            if possrand < t2StealCutoff:
                ...
                if otherTO < 0.582:
                    ...
                    msg = possession + ": Shot clock violation on " + t2 + " " + printShooter + "."
                    collector.AppendPlay(possession, msg, "Turnover", t1pts, t2pts, possessionNum, total_possessions)
                elif otherTO < 1:
                    msg = possession + ": Offensive foul on " + t2 + " " + printShooter + "."
                    toPlayer.Stats.AddFoul()
                    team_two.Stats.AddFoul()
                    collector.AppendPlay(possession, msg, "Turnover", t1pts, t2pts, possessionNum, total_possessions)
                possession = t1
                ...
                if eventOutcome < made3Cutoff:
                    ...
                    if rebrand < t2OffensiveRebound:
                        ...
                        printt2Rebounder = t2rebounder.FirstName + " " + t2rebounder.LastName
                        msg += "       Rebounded by " + t2 + " " + printt2Rebounder + "."
                        collector.AppendPlay(possession, msg, "Score", t1pts, t2pts, possessionNum, total_possessions)
                        possession = t2
                    else:
                        pickt1Rebounder = random.choices(gett1Players,weights=[x.ReboundingPer for x in team_one_roster],k=1)
                    ...
                    team_two.Stats.AddThreePointShot(False)
                    printBlocker = blocker.FirstName + " " + blocker.LastName
                    msg = printShooter + " 3-point attempt...BLOCKED by " + t1 + " " + printBlocker + "."
                    rebrand = random.random()
                    if rebrand < 0.43:
                        pickt2Rebounder = random.choices(gett2Players,weights=[x.ReboundingPer for x in team_two_roster],k=1)
                        t2rebounder = pickt2Rebounder[0]
                    ...
                    msg = printShooter + " 3-point attempt... Missed with a foul on the play."
                    shooter.Stats.AddFieldGoal(False, 3)
                    team_two.Stats.AddThreePointShot(False)
                    ...
                    while foulShots > 0:
                        if random.random() <= ftCutoff:
                            ...
                            team_two.Stats.AddPoints(1, possessionNum, halftime_point, is_ot)
                    ...
                    msg = printShooter + " 3-point attempt...Score! There is a foul on the play and one!"
                    t2pts += 3
                    shooter.Stats.AddFieldGoal(True, 3)
                    team_two.Stats.AddThreePointShot(True)
                    team_two.Stats.AddPoints(3, possessionNum, halftime_point, is_ot)
                ...
                if eventOutcome < made2jCutoff:
                    ...
                    msg = printShooter + " 2-point jumper... Missed but there is a foul on the play."
                    shooter.Stats.AddFieldGoal(False, 2)
                    team_two.Stats.AddFieldGoal(False)
                    team_one.Stats.AddFoul()
                    foulShots = 2
                    ...
                    msg = printShooter + " 2-point jumper...Score! Foul on the play and we go to a free throw!"
                    t2pts += 2
                    shooter.Stats.AddFieldGoal(True, 2)
                    team_two.Stats.AddFieldGoal(True)
                    team_two.Stats.AddPoints(2, possessionNum, halftime_point, is_ot)
                ...
                if eventOutcome < made2iCutoff:
                    ...
                    msg = printShooter + " Inside shot... Missed but with a foul on the play."
                    team_one.Stats.AddFoul()
                    shooter.Stats.AddFieldGoal(False, 2)
                    team_two.Stats.AddFieldGoal(False)
                    foulShots = 2
                    ...
                    msg = printShooter + " Inside shot...Score! Fouled and we have a free throw folks!"
                    t2pts += 2
                    shooter.Stats.AddFieldGoal(True, 2)
                    team_two.Stats.AddFieldGoal(True)
                    team_two.Stats.AddPoints(2, possessionNum, halftime_point, is_ot)
    ...
    UserString = ""
    if (HomeCoach != "AI" and HomeCoach != "") or (AwayCoach != "AI" and AwayCoach != ""):
        UserString = "USER_"

    file_name = play_by_play_path + "/" + UserString + gameid + "_" + t1 + "_" + t2 + ".csv"
    with open(file_name, 'w', newline='') as csvfile:
        fieldnames = ['Team', 'Result', 'PlayType', 'TeamOneScore', 'TeamTwoScore', 'Possession', 'Total Possessions']
        writer = csv.writer(csvfile)
        writer.writerow(['HomeTeam', 'AwayTeam', 'HomeTeamScore', 'AwayTeamScore', 'Total Possessions'])
        writer.writerow([hometeam, awayteam, str(t1pts), str(t2pts), str(total_possessions)])
        writer.writerow([''])
        writer.writerow(fieldnames)
        for x in collector.List:
            writer.writerow([x["Team"], x["Result"], x["PlayType"], x["TeamOneScore"], x["TeamTwoScore"], x["Possession"], x["Total Possessions"]])
    ...
    with open(file_name, 'w', newline='') as csvfile:
        ...
        box_score_writer.writerow([team_one.TeamName, team_one.Mascot, str(team_one.Stats.FirstHalfScore), str(team_one.Stats.SecondHalfScore), str(team_one.Stats.OvertimeScore), str(t1pts)])
        box_score_writer.writerow([team_two.TeamName, team_two.Mascot, str(team_two.Stats.FirstHalfScore), str(team_two.Stats.SecondHalfScore), str(team_two.Stats.OvertimeScore), str(t2pts)])
...
with open('NCAA Schedule - Week ' +num+'.csv', newline='') as csvfile:
    ...
    for row in reader:
        if row[0] == "Monday" or row[0] == "GameID" or row[0] == "Tuesday" or row[0] == "Wednesday" or row[0] == "Thursday" or row[0] == "Saturday" or row[0] == "":
            continue
